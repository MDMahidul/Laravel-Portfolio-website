    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <p class="footer-text"><i class="fas fa-phone"></i> ০১৭১০৬১১৯৮০ </p>
                <p class="footer-text"><i class="fas fa-envelope"></i> mmbmahidul007@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link" target="_blank" href="/Policy">গোপনীয়তা নীতি</a><br>
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব মোঃ মাহিদুল ইসলাম দ্বারা সংরক্ষিত; ২০২০-২০২১ </p>
</div>
